...
namespace Schendel_Final.Controllers
{
    ...
    public class StudentCoursesController : ControllerBase
    {
        ...
        public StudentCoursesController(SchendelcsfinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<StudentCourse>> PostStudentCourse(StudentCourse studentCourse)
        {
          if (_context.StudentCourse == null)
          {
              return Problem("Entity set 'SchendelcsfinalContext.StudentCourse'  is null.");
          }
        ...
        {
            return (_context.StudentCourse?.Any(e => e.StudentId == id)).GetValueOrDefault();
        }
    }
}
